            ...
            <div class="row add_btn_area">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="username" id="username" placeholder="請輸入帳號" required value="<?php echo $datas['username'];?>">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="name" id="name" placeholder="請輸入暱稱" required value="<?php echo $datas['name'];?>">
                    </div>
                  </div>
                  <div class="form-group">
            ...
            $('#register_form').on("submit",function(){                   
                ...
                //密碼正確    
                   // $("#password").on("keyup",function(){
                    $.ajax({
                        type : "POST", //表單傳送的方式 同 form 的method屬性
                        url  : "../update_user.php", //目標給哪個檔案 同 form 的 action 屬性
                        data : {//為要傳過去的資料 使用物件方式呈現 因為變數key值為英文的關係 所以用物件方式送 。 ex{name : "輸入的名子",password : "輸入的密碼"}
                        'id'    : $("#id").val(),
